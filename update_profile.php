...
<section class="form-container" style="background-color: #F8F4E1; color:aliceblue">
<form action="" method="post" style="background-color: #AF8F6F; padding: 30px; border-radius: 10px; box-shadow: 10px 20px 40px rgba(0, 0, 0, 0.2), 0 6px 20px rgba(0, 0, 0, 0.19); background-size: cover;">
